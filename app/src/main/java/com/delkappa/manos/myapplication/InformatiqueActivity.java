...
public class InformatiqueActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabase = FirebaseDatabase.getInstance().getReference("Informatique");
        ...
        mDatabase.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot singleSnapshot : dataSnapshot.getChildren()){
                    ...
                    guiManager.generateUsersButtons(user, i, InformatiqueActivity.this, findViewById(android.R.id.content).getRootView());
                    i++;
                }
            }
